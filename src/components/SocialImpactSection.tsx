  ...
  return (
    <section id="social-impact" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-primary/5 via-background to-secondary/5 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3-Card Layout with Navigation */}
        <div className="relative">
          {/* Navigation Buttons */}
          <div className="flex absolute top-1/2 -translate-y-1/2 left-0 right-0 justify-between pointer-events-none z-10 px-4">
            <motion.button
              onClick={handlePrevious}
              className="p-3 bg-white/90 hover:bg-white text-primary rounded-full shadow-lg hover:shadow-xl transition-all duration-300 pointer-events-auto hover:scale-110"
          ...
          {/* Cards Grid - Always showing 3 cards */}
